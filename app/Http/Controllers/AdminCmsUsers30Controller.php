<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers30Controller extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Privileges","name"=>"id_cms_privileges","join"=>"cms_privileges,name");
			...
			//$this->form[] = ["label"=>"Nomor Kepegawaian","name"=>"nomor_kepegawaian","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
